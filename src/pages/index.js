...
function Home() {
  ...
  React.useEffect(() => {
    fetch("https://api.github.com/repos/CIRES-Hub/BiasNavi")
      .then((res) => res.json())
  ...
  return (
    <Layout
      ...
      description="A data bias management toolkit"
    >
      <Head>
        <meta property="og:title" content="Biasnavi" />
        <meta
          property="og:description"
          content="A data bias management toolkit"
        />
        <meta
          property="og:image"
        ...
        <meta property="og:site_name" content="Biasnavi" />
        <meta name="twitter:image:alt" content="Biasnavi" />
        <meta
          name="twitter:image"
          content="https://react-native-aria.geekyants.com/img/banner.png"
        />
          ...
          <div className="row">
            <div className="col col--6">
              <h1 className="hero__title hero__title--left">
                A data bias management toolkit
              </h1>
            ...
            <div className="col col--6 hero-image">
              <img src="img/logo-large.png" alt="Biasnavi logo"></img>
            </div>
          </div>
        </div>
      </header>
